...
var _resolveOptionStacked = function(option, options) {
    // See if we can find an option spec, where the
    // to-be-resolved option's stack string has right-
    // bounded substring that matches any of the spec's
    // flag's argument names.
    //
    // XXX: Do we need more control here?
    //
    // XXX: Implement this...
};
