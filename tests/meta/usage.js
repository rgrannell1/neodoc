...
describe('defaults', function() {
    ...
    describe('naval_fate ship new <name> ...', function() {
        it('should parse', function() {
            ...
            assert.strictEqual(line[0][0].type, nodes.OPT_TYPE.COMMAND);
            assert.strictEqual(line[0][0].name, 'ship');

            assert.strictEqual(line[0][1].type, nodes.OPT_TYPE.COMMAND);
            assert.strictEqual(line[0][1].name, 'new');

            assert.strictEqual(line[0][2].type, nodes.OPT_TYPE.POSITIONAL);
    ...
    describe('naval_fate ship <name> move <x> <y> [--speed=<kn>]', function() {
        it('should parse', function() {
            ...
            assert.strictEqual(line[0][1].type, nodes.OPT_TYPE.POSITIONAL);
            ...
            assert.strictEqual(line[0][2].type, nodes.OPT_TYPE.COMMAND);
            assert.strictEqual(line[0][2].name, 'move');
            assert.strictEqual(line[0][2].modifiers.repeating, false);

            assert.strictEqual(line[0][3].type, nodes.OPT_TYPE.POSITIONAL);
            ...
            assert.strictEqual(line[0][4].type, nodes.OPT_TYPE.POSITIONAL);
            ...
            assert.strictEqual(line[0][5].type, nodes.OPT_TYPE.FLAG_LONG);
    ...
    describe('naval_fate mine (set|remove) <x> <y> [--moored|--drifting]', function() {
        it('should parse', function() {
            ...
            assert.strictEqual(line[0][1].type, nodes.OPT_TYPE.GROUP);
            assert.strictEqual(line[0][1].required, true);

            assert.strictEqual(line[0][1].nodes[0][0].type, nodes.OPT_TYPE.COMMAND);
            assert.strictEqual(line[0][1].nodes[0][0].name, 'set');
            assert.strictEqual(line[0][1].nodes[0][0].modifiers.repeating, false);

            assert.strictEqual(line[0][1].nodes[1][0].type, nodes.OPT_TYPE.COMMAND);
            ...
            assert.strictEqual(line[0][4].type, nodes.OPT_TYPE.GROUP);
            assert.strictEqual(line[0][4].required, false);

            assert.strictEqual(line[0][4].nodes[0][0].type, nodes.OPT_TYPE.FLAG_LONG);
            ...
            assert.strictEqual(line[0][4].nodes[1][0].type, nodes.OPT_TYPE.FLAG_LONG);
